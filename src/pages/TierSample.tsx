        ...
        <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="space-y-4">
            <div className="card-surface grid grid-cols-2 gap-3 p-4">
              ...
              <div className="rounded-xl border border-stone-200/80 bg-white/80 p-4 text-center">
                <p className="text-xs uppercase tracking-[0.14em] text-stone-500">{t('Tabs Included')}</p>
                <p className="mt-2 text-2xl font-semibold text-stone-900">{sample.tabs.length}</p>
              </div>
              <div className="rounded-xl border border-stone-200/80 bg-white/80 p-4 text-center">
                <p className="text-xs uppercase tracking-[0.14em] text-stone-500">{t('Guest Feel')}</p>
                <p className="mt-2 text-sm font-semibold text-stone-900">{t('Polished & interactive')}</p>
              </div>
            </div>
      ...
      <section className="page-wrap section-gap">
        ...
        {activeTab === 'home' && (
          <div className="space-y-4">
            <div className={sectionCard}>
              ...
              <p className="mt-2 text-sm leading-7 text-stone-600">{t(sample.couple.story)}</p>
            ...
            <div className="space-y-4">
              <div className={sectionCard}>
                ...
                <ul className="mt-3 space-y-2 text-sm leading-6 text-stone-600">
                  <li>{t('Venue parking is available for all guests.')}</li>
                  <li>{t('Hotel recommendations and room blocks can be listed here.')}</li>
                  <li>{t('Add map embeds or transport details on higher tiers.')}</li>
                </ul>
              </div>
              <div className={sectionCard}>
          ...
          <div className="grid gap-4 lg:grid-cols-[1fr_0.95fr]">
            <div className={sectionCard}>
              ...
              <p className="mt-2 text-sm text-stone-600">
                {language === 'mk'
                  ? `ÐžÐ²Ð° Ð´ÐµÐ¼Ð¾ Ð¿Ð¾ÐºÐ°Ð¶ÑƒÐ²Ð° ÐºÐ°ÐºÐ¾ Ð¼Ð¾Ð¶Ðµ Ð´Ð° Ð¸Ð·Ð³Ð»ÐµÐ´Ð° RSVP Ð¸ÑÐºÑƒÑÑ‚Ð²Ð¾Ñ‚Ð¾ Ð·Ð° Ð³Ð¾ÑÑ‚Ð¸ Ð·Ð° Ð¿Ð°ÐºÐµÑ‚Ð¾Ñ‚ ${t(sample.name)}.`
                  : `This demo shows how a guest RSVP flow can feel for the ${sample.name} tier.`}
              </p>
        ...
        {activeTab === 'seating' && (
          <div className={sectionCard}>
            ...
            <p className="mt-2 text-sm text-stone-600">{t('Premium sample seating overview for guests and organizers.')}</p>
